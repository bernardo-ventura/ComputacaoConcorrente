...
//#define L 6 //outra opção de número de threads
//#define E 4 //outra opção de número de threads
//#define L 2 //outra opção de número de threads
//#define E 4 //outra opção de número de threads

//variaveis do problema
int leit=0; //contador de threads lendo
int escr=0; //contador de threads escrevendo
int trava=0; //variável para travar o leitor
